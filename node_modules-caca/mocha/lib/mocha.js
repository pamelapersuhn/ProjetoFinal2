...
var builtinReporters = require('mocha/lib/reporters/index.js');
var utils = require('mocha/lib/utils.js');
var mocharc = require('mocha/lib/mocharc.json');
var Suite = require('mocha/lib/suite.js');
var esmUtils = require('mocha/lib/nodejs/esm-utils.js');
var createStatsCollector = require('mocha/lib/stats-collector.js');
const {
...
} = require('mocha/lib/errors.js');
const {EVENT_FILE_PRE_REQUIRE, EVENT_FILE_POST_REQUIRE, EVENT_FILE_REQUIRE} =
  Suite.constants;
var debug = require('debug')('mocha:mocha');

/**
 * @typedef {import('mocha/lib/types.ts').DoneCB} DoneCB
 * @typedef {import('mocha/lib/types.ts').MochaGlobalFixture} MochaGlobalFixture
 * @typedef {import('mocha/lib/types.ts').MochaOptions} MochaOptions
 * @typedef {import('mocha/lib/types.ts').MochaRootHookObject} MochaRootHookObject
 * @typedef {import('mocha/lib/types.ts').Reporter} Reporter
 */
...
exports.utils = utils;
exports.interfaces = require('mocha/lib/interfaces/index.js');
/**
 * @public
 * @memberof Mocha
 */
exports.reporters = builtinReporters;
exports.Runnable = require('mocha/lib/runnable.js');
exports.Context = require('mocha/lib/context.js');
/**
 *
 * @memberof Mocha
 */
exports.Runner = require('mocha/lib/runner.js');
exports.Suite = Suite;
exports.Hook = require('mocha/lib/hook.js');
exports.Test = require('mocha/lib/test.js');
...
Mocha.unloadFile = function (file) {
  ...
  return require('mocha/lib/nodejs/file-unloader.js').unloadFile(file);
};
 ...
 * @returns {import("mocha/lib/runner.js")} runner instance
 * @example
 *
...
Mocha.prototype.parallelMode = function parallelMode(enable = true) {
  ...
  this._runnerClass = parallel
    ? require('mocha/lib/nodejs/parallel-buffered-runner.js')
    : exports.Runner;
