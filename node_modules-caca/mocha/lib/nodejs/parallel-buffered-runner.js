...
/**
 * @typedef {import('mocha/lib/types.ts').FileRunner} FileRunner
 * @typedef {import('mocha/lib/types.ts').RunnerOptions} RunnerOptions
 * @typedef {import('mocha/lib/types.ts').SerializedWorkerResult} SerializedWorkerResult
 * @typedef {import('mocha/lib/types.ts').SigIntListener} SigIntListener
 */

const Runner = require('mocha/lib/runner.js');
const {EVENT_RUN_BEGIN, EVENT_RUN_END} = Runner.constants;
const debug = require('debug')('mocha:parallel:parallel-buffered-runner');
const {BufferedWorkerPool} = require('mocha/lib/nodejs/buffered-worker-pool.ts');
const {setInterval, clearInterval} = global;
const {createMap, constants} = require('mocha/lib/utils.js');
const {MOCHA_ID_PROP_NAME} = constants;
const {createFatalError} = require('mocha/lib/errors.js');
